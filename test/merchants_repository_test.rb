...
class MerchantsRepositoryTest < Minitest::Test
  ...
  def test_it_can_recognize_its_data_file
    merchants_repo = MerchantsRepository.new(nil, "./data/merchants.csv")
    assert merchants_repo.check_for_file("./data/merchants.csv")
  end

  def test_it_can_output_its_data_from_the_file
    merchants_repo = MerchantsRepository.new(nil, "./data/merchants.csv")
    refute_equal "", merchants_repo.output_file_contents("./data/merchants.csv")
  end
